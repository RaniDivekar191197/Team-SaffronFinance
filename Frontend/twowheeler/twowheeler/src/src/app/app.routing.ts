...
import { DocumentuploadComponent } from './module/operationexecutive/documentupload/documentupload.component';
...
export const AppRoutes: Routes = [
  ...
  {
    path: 'role',
    component: AdminLayoutComponent,       //header footer always same for all child
    children: [
